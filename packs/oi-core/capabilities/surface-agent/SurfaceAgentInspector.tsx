...
type SurfaceAgentInspectorProps = InspectorCommonProps<
  EaCAgentDetails,
  SurfaceAgentStats
>;
    ...
    <div class="space-y-4">
      <div>
        ...
        <Input
          ...
          value={apiKey}
          onChange={(e: any) =>
            onChange({ apiKey: e.target.value, systemPrompt, promptTemplate })
          }
        />
      </div>
      ...
      <div>
        ...
        <Input
          ...
          value={systemPrompt}
          onChange={(e: any) =>
            onChange({ apiKey, systemPrompt: e.target.value, promptTemplate })
          }
        />
      </div>
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e: any) =>
            onChange({ apiKey, systemPrompt, promptTemplate: e.target.value })
          }
        />
      </div>
