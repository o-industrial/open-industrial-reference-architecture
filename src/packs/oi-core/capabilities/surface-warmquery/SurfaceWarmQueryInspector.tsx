import { NodeStatTile, InspectorBase } from '../../../../../atomic/.exports.ts';
...
type SurfaceWarmQueryInspectorProps = InspectorCommonProps<EaCWarmQueryDetails, SurfaceWarmQueryStats>;
